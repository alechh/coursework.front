const data = [
    {
        ...
        teacherContacts: 'abstact1@spbu.ru',
        ...
        aboutMe: 'Я мастерски печатая на клавиатуре не глядя не неё',
        id : '1' 
    },
    {
        ...
        aboutMe: 'Мне кажется, я преуспею в этой области',
        id : '2' 
    },
    {
        title:'Тема курсовой 3',
        teacher:'Абстрактный преподаватель 3',
        teacherContacts: 'abstact3@spbu.ru',
        scienceArea : 'Веб-приложения',
        description: '«Князь Андрей вышел в переднюю и, подставив плечи лакею, накидывавшему ему плащ, равнодушно прислушивался к болтовне своей жены с князем Ипполитом, вышедшим тоже в переднюю. Князь Ипполит стоял возле хорошенькой беременной княгини и упорно смотрел прямо на нее в лорнет.', 
        aboutMe: 'У меня есть опыт написания курсовых работ в этой области',
        id : '3' 
    }
]
