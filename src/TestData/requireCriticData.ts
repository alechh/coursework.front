const data = [
    ...
    },
    {
        ...
        teacher:'Евгение Онегин',
        teacherContacts: 'ltolstoy@spbu.ru',
        scienceArea : 'Веб-приложения',
        description: 'Разработать поисковик', 
        reportFile: 'Отчет.doc',
        presentationFile: '',
        consultantReportFile:'',
        link: 'ya.ru',
        consultant : 'Пушкин Александр Сергеевич',
    ...
    {
        title:'Видеохостинг',
        teacher:'Никола Тесла',
        teacherContacts: 'ltolstoy@spbu.ru',
        scienceArea : 'Веб-приложения',
        description: 'Сделать второй Ютуб', 
        reportFile: 'Отчет.пдф',
        presentationFile: '',
        consultantReportFile:'review.txt',
        link: 'rutube.ru',
        consultant : 'Пушкин Александр Сергеевич',
        consultantContacts : 'apushkin@spbu.ru',
        status : 'защищена',
